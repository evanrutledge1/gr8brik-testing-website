...
<body class="w3-light-blue w3-container">
    ...
    <div class="w3-content w3-card-8" style="max-width:800px;position:relative">
        ...
        <a href="#feed"><img class="mySlides" src="img/feed.jpg" style="width:100%" loading='lazy' class="w3-animate-right"></a>
        <a href="#community"><img class="mySlides" src="img/com.jpg" style="width:100%" loading='lazy' class="w3-animate-right"></a>
        <a href="#creations"><img class="mySlides" src="img/creations.jpg" style="width:100%" loading='lazy' class="w3-animate-right"></a>
        <a href="#uploads"><img class="mySlides" src="img/upload.jpg" style="width:100%" loading='lazy' class="w3-animate-right"></a>

        <a class="w3-btn-floating w3-blue w3-hover-opacity w3-round" style="position:absolute;top:45%;left:0" onclick="plusDivs(-1)">&#8592;</a>
        <a class="w3-btn-floating w3-blue w3-hover-opacity w3-round" style="position:absolute;top:45%;right:0" onclick="plusDivs(1)">&#8594;</a>
    ...
    function showDivs(n) {
        ...
        x.hide(); // Hide all slides
        x.eq(slideIndex - 1).show(); // Show the current slide
    }
});
    ...
    <div class="w3-container w3-center" id="main">
        ...
        <a href="/acc/login.php" class="w3-btn w3-blue w3-border">LOGIN</a>

        <a href="/acc/register.php" class="w3-btn w3-blue w3-border">REGISTER</a>

    </div><hr />

            <div id="feed">
                <img class="w3-left w3-card-8 w3-mobile" src="img/feed.jpg" width="25%" height="25%" alt="User PFP" loading='lazy'><br />
                ...
                <a href="/acc/register.php" class="w3-btn w3-blue w3-border">REGISTER</a><hr />
            </div>

            <div id="community">
                <img class="w3-right w3-card-8 w3-mobile" src="img/com.jpg" width="25%" height="25%" alt="User PFP" loading='lazy'><br />
            ...
            <div id="creations">
                <img class="w3-left w3-card-8 w3-mobile" src="img/creations.jpg" width="25%" height="25%" alt="Blured creation" loading='lazy'><br />
                ...
                <a href="list.php" class="w3-btn w3-blue w3-border">CREATIONS</a><hr />
            </div>

            <div id="uploads">
                <img class="w3-right w3-card-8 w3-mobile" src="img/upload.jpg" width="25%" height="25%" alt="Blured creation" loading='lazy'><br />
                ...
                <a href="/acc/index.php#upload" class="w3-btn w3-blue w3-border">UPLOAD</a><hr />
            </div>
