...
if(!file_exists('cre/' . $_SERVER['QUERY_STRING'] . '.json')){
...
if(isset($_POST['comment'])) {
    ...
    if (!isset($_SESSION['username']) || $_SESSION['username'] == '') {
        ...
        echo "<h4 class='alert w3-padding w3-red' id='alert'>Please login to comment<button class='close w3-btn w3-blue w3-hover-opacity' id='close'>okay</button></h4>";
