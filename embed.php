...
<center>
    ...
    <a href="../index.php" class='w3-btn w3-large w3-green w3-hover-white w3-card-24' title="GR8BRIK homepage" download><i class="fa fa-home" aria-hidden="true"></i></a>
    <a href="<?PHP echo $file ?>" class='w3-btn w3-large w3-green w3-hover-white w3-card-24' title="Download model" download><i class="fa fa-download" aria-hidden="true"></i></a>
